...
const Auth = () => {
  ...
  return (
    <>
      ...
      <div className="bg-background flex flex-col items-center justify-center sm:justify-start px-2 sm:px-4 py-2 sm:py-6 md:py-8 min-h-[calc(100vh-3.5rem)] sm:min-h-screen">
